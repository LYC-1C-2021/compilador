...
%%
programa: declaracion inicio	{printf("\n---------------------------\n");}
								{printf("\n****COMPILACION EXITOSA****\n");}
								{printf("\n---------------------------\n");} 
		 | declaracion 			{printf("\n---------------------------\n");}
								{printf("\n****COMPILACION EXITOSA****\n");}
...
definicion: lista |  lista definicion
			{
				printf("\n***REGLA 2 -> Declaracion:\n");
				printf("\t\t\tDefiniciones\n");
			}
...
interacion:WHILE condicion L_A lista_sentencias L_C
			{
...
factor: ID 
		{
			...
			printf("\t\t\t ID\n");
			/*guardo el termino en el arbol de ejecucion*/
	        nodo_factor =  crear_hoja(crear_info(yytext));
...
lista_io: lista_io entsal					{printf("\n***REGLA 48 -> Lista_io:\n");}
